                    ...
                    <div class="masthead-overlay d-flex align-items-center justify-content-center pt-5 ps-1">
                        ...
                        <div class="d-flex align-items-center flex-nowrap w-100">
                            ...
                            if ($header_logo && $show_logo) {
                                echo '<img class="masthead-logo me-3" src="' . esc_url($header_logo) . '" style="max-width: 20%; height: auto;">';
                            }
                            ?>
                            <div class="d-flex flex-column ms-3 flex-grow-1">
                                <?php if ($show_main_header): ?>
                                    <h1 class="masthead-heading" style="white-space: nowrap;">
                                        <?php
                                ...
                                <?php endif; ?>
                                <?php if ($show_text): ?>
                                    <h2 class="masthead-subheading" style="white-space: nowrap;">
                                        <?php
