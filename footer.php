<!-- Footer-->
<footer class="container footer text-center" style="background: <?php echo esc_attr(get_theme_mod('footer_enable_gradient', true) ? "linear-gradient(0deg, " . get_theme_mod('footer_gradient_color', '#101010') . " 0%, " . get_theme_mod('footer_background_color', '#000000') . " 100%)" : get_theme_mod('footer_background_color', '#000000')); ?>;">
